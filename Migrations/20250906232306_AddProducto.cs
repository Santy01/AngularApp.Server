    ...
    public partial class AddProducto : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Productos",
                columns: new[] { "Id", "Activo", "Codigo", "Descripcion", "Nombre", "PrecioCompra", "PrecioVenta", "Stock" },
                values: new object[,]
                {
                    { 1, true, "P-001", "14'' 8GB RAM", "Laptop básica", 400m, 550m, 10 },
                    { 2, true, "P-002", "2.4G", "Mouse inalámbrico", 5m, 12.5m, 100 }
                });
        }
